...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _detectCountryFromLocale() {
    ...
    final locale = Platform.localeName; // e.g., 'en_US', 'en_GB', 'es_ES'
  ...
  String _getPhoneHint() {
    ...
    switch (_selectedCountryIso) {
      ...
      case 'GB': return '7123 456789';
      case 'FR': return '6 12 34 56 78';
      case 'DE': return '160 1234567';
          ...
          child: Column(
            ...
            children: [
                        ...
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              color: !_isSignUp ? Color(0xFFDD2C00) : Colors.grey[600],
                            ),
                          ),
                        ),
                      ),
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            if (digitsOnly.isNotEmpty) {
                              PhoneNumberFormatter formatter = PhoneNumberFormatter(value);
                              _phoneController.text = formatter.format(digitsOnly);
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Password',
                  hintText: _isSignUp ? 'Enter password' : 'Auto-filled for testing',
              ...
              ...testUsers.map((user) {
                return Padding(
                  ...
                  child: GestureDetector(
                    onTap: _isLoading ? null : () => _quickLogin(user['id']!, user['name']!),
                    child: Container(
