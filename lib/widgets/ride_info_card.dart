...
class RideInfoCard extends StatelessWidget {
  // RouteInfo-based parameters
  final RouteInfo? selectedRoute;
  final int? originIndex;
  final int? destinationIndex;

  // String-based parameters (for when RouteInfo is not available)
  ...
  final bool embedded; // When true, removes container styling for embedding in other widgets
  final bool centered; // When true, centers content (default: true for non-embedded, false for embedded)
  ...
  const RideInfoCard({
    ...
    this.embedded = false,
    this.centered = true, // Default to centered
  });
  ...
  Widget build(BuildContext context) {
    ...
    // Build the content (route name + stops row)
    // Use centered parameter to control alignment
    ...
    // For embedded mode, return content with full width to match message bubbles
    if (embedded) {
      return SizedBox(
