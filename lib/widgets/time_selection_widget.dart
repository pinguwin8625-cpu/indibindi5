...
class TimeSelectionWidgetState extends State<TimeSelectionWidget> {
  ...
  Widget _buildHourWheel(Color color, DateTime tempPickedDate, 
      ...
      onSelectedItemChanged: (index) {
        ...
        if (isEditingArrival ? _isValidArrivalTime(testTime) : _isValidDepartureTime(testTime)) {
          ...
          validTime = isEditingArrival 
              ...
              : _findEarliestValidDepartureTime(DateTime(tempPickedDate.year, tempPickedDate.month, tempPickedDate.day));
  ...
  Widget _buildMinuteWheel(Color color, DateTime tempPickedDate,
                          FixedExtentScrollController hourController,
                          FixedExtentScrollController minuteController,
                          Function(DateTime) onValidTimeChanged) {
    return ListWheelScrollView(
      ...
      onSelectedItemChanged: (index) {
        ...
        if (isEditingArrival ? _isValidArrivalTime(testTime) : _isValidDepartureTime(testTime)) {
          ...
          validTime = isEditingArrival 
              ? _findEarliestValidArrivalTime(DateTime(tempPickedDate.year, tempPickedDate.month, tempPickedDate.day, tempPickedDate.hour))
              : _findEarliestValidDepartureTime(DateTime(tempPickedDate.year, tempPickedDate.month, tempPickedDate.day, tempPickedDate.hour));
